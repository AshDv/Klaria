...
8. Le bot surveille la commande « STOP NOLYA » sans conserver le chat.
9. À la fin, Mistral Medium 3.5 produit un objet JSON validé par Pydantic.
10. Le bot publie un récapitulatif et le lien Nolya dans le chat, puis quitte la réunion.
11. Nolya garde le rapport et demande la purge de la réunion temporaire chez Vexa.
