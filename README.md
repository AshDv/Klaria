...
Nolya rejoint une réunion Google Meet ou Microsoft Teams, produit une transcription
...
- commande `STOP NOLYA` dans le chat avec arrêt et effacement immédiats ;
...
- publication du récapitulatif et du lien Nolya dans le chat avant le départ du bot ;
...
Pour activer le bot en ligne, `VEXA_API_KEY` est obligatoire. Sans SMTP, Nolya ne
