...
Write-Host "Préparation du backend Nolya..." -ForegroundColor Cyan
...
Write-Host "Lancement de Nolya..." -ForegroundColor Cyan
...
Write-Host "Nolya : http://localhost:5174" -ForegroundColor Green
